...
const DesktopTable = ({
  ...
  const showEditOrderForm = (index: any, order: { size: SetStateAction<string>; price: SetStateAction<string> }) => {
...
const MobileTable = ({
  // @ts-ignore
  cancelledOrderId,// @ts-ignore
  editOrderIndex,// @ts-ignore
  handleCancelOrder,// @ts-ignore
  handleModifyOrder,// @ts-ignore
  modifiedOrderId,// @ts-ignore
  openOrders,// @ts-ignore
  setEditOrderIndex,// @ts-ignore
}) => {
  const { t } = useTranslation('common')
  const [modifiedOrderSize, setModifiedOrderSize] = useState('')
  const [modifiedOrderPrice, setModifiedOrderPrice] = useState('')

  const showEditOrderForm = (index: any) => {
    setEditOrderIndex(index)
...
const OpenOrdersTable = () => {
  ...
  const handleModifyOrder = async (
    ...
    const mangoClient = useMangoStore.getState().connection.client// @ts-ignore
    const marketConfig = useMangoStore.getState().selectedMarket.config// @ts-ignore
    ...
    const referrerPk = useMangoStore.getState().referrerPk// @ts-ignore
