...
const NewAccount: FunctionComponent<NewAccountProps> = ({
  ...
  const onChangeAmountInput = (amount:any) => {
    setInputAmount(amount)
    setDepositPercentage('')
    setInvalidAmountMessage('')
  }

  const onChangeAmountButtons = async (percentage: any) => {
  ...
  const onChangeNameInput = (name: any) => {
    setName(name)
    ...
    <>
      ...
      <div className="flex">
        <Input
          ...
          onBlur={(e:any) => validateAmountInput(e.target.value)}
          value={inputAmount || ''}
