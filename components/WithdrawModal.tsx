...
const WithdrawModal: FunctionComponent<WithdrawModalProps> = ({
  ...
  const handleSetSelectedAsset = (symbol: React.SetStateAction<string>) => {
    setInputAmount('')
  ...
  const handleIncludeBorrowSwitch = (checked: boolean | ((prevState: boolean) => boolean)) => {
  ...
  const validateAmountInput = (amount: any) => {
  ...
  const getTokenBalances = () => {// @ts-ignore
    const mangoCache = useMangoStore.getState().selectedMangoGroup.cache// @ts-ignore
        ...
        {!showSimulation ? (
          <>
            ...
            <Select
              ...
              onChange={(asset: React.SetStateAction<string>) => handleSetSelectedAsset(asset)}
            >
            ...
            <div className="flex">
              <Input
                ...
                placeholder="0.00"
                value={inputAmount}
                onBlur={(e: { target: { value: any } }) => validateAmountInput(e.target.value)}
              ...
              {simulation ? (
                ...
                >
                  <span
                    className={`${getAccountStatusColor(// @ts-ignore
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <span className="flex h-2 w-2 mr-2.5 relative">
                          <span
                            className={`animate-ping absolute inline-flex h-full w-full rounded-full ${getAccountStatusColor(// @ts-ignore
                              simulation.initHealthRatio,
                              false,
                              true
                            )} opacity-75`}
                          ></span>
                          <span
                            className={`relative inline-flex rounded-full h-2 w-2 ${getAccountStatusColor(// @ts-ignore
                              simulation.initHealthRatio,
                              false,
                              true
                            )}`}
                    ...
                    {simulation ? (
                      <div>
                        ...
                        <div className="flex justify-between pb-2">
                          ...
                          <div className="text-th-fgd-1">
                            {getAccountStatusColor(// @ts-ignore
                              simulation.initHealthRatio,
                              true
                            )}
                          </div>
